...
export const CATALOG_BEADS: CatalogBead[] = [
  ...
  { id: "cb-004", name: "Walnut",         nameRu: "Орех",               shape: "oblate",    size: 0.24, material: "wood", color: "#5C4033" },
  ...
  { id: "cb-007", name: "Ash",            nameRu: "Ясень",              shape: "buckyball", size: 0.18, material: "wood", color: "#C0C0C0" },
  ...
  { id: "cb-011", name: "Cedar",          nameRu: "Кедр",               shape: "oblate",    size: 0.19, material: "wood", color: "#A0522D" },
  ...
  { id: "cb-015", name: "Ebony",          nameRu: "Эбеновое дерево",    shape: "buckyball", size: 0.20, material: "wood", color: "#2C1810" },
  ...
  { id: "cb-018", name: "Mahogany",       nameRu: "Махагони",           shape: "oblate",    size: 0.24, material: "wood", color: "#6B3A2A" },
  ...
  { id: "cb-022", name: "Larch",          nameRu: "Лиственница",        shape: "oblate",    size: 0.23, material: "wood", color: "#A67B5B" },
  ...
  { id: "cb-025", name: "Sand Wood",      nameRu: "Песочное дерево",    shape: "buckyball", size: 0.21, material: "wood", color: "#C2B280" },

  // ── Silicone (cb-026 .. cb-050) ──────────────────────────────────────────
  { id: "cb-026", name: "Pink Cloud",     nameRu: "Розовое облако",     shape: "oblate",    size: 0.20, material: "silicone", color: "#FFB6C1" },
  { id: "cb-027", name: "Sky Blue",       nameRu: "Небесный голубой",   shape: "sphere",    size: 0.22, material: "silicone", color: "#87CEEB" },
  { id: "cb-028", name: "Mint Dream",     nameRu: "Мятная мечта",       shape: "buckyball", size: 0.18, material: "silicone", color: "#98FF98" },
  ...
  { id: "cb-032", name: "Baby Pink",      nameRu: "Детская роза",       shape: "oblate",    size: 0.19, material: "silicone", color: "#F4A7BB" },
  { id: "cb-033", name: "Powder Blue",    nameRu: "Пудровый голубой",   shape: "sphere",    size: 0.20, material: "silicone", color: "#B0E0E6" },
  { id: "cb-034", name: "Seafoam",        nameRu: "Морская пена",       shape: "buckyball", size: 0.22, material: "silicone", color: "#96D9C5" },
  ...
  { id: "cb-038", name: "Blush",          nameRu: "Румянец",            shape: "oblate",    size: 0.21, material: "silicone", color: "#DE5D83" },
  ...
  { id: "cb-041", name: "Soft Violet",    nameRu: "Мягкая фиалка",      shape: "buckyball", size: 0.20, material: "silicone", color: "#C9A0DC" },
  ...
  { id: "cb-045", name: "Dusty Rose",     nameRu: "Сухая роза",         shape: "oblate",    size: 0.19, material: "silicone", color: "#DCAE96" },
  ...
  { id: "cb-048", name: "Salmon",         nameRu: "Лосось",             shape: "buckyball", size: 0.20, material: "silicone", color: "#FA8072" },
  ...
  { id: "cb-052", name: "Terracotta",     nameRu: "Терракота",           shape: "oblate",    size: 0.20, material: "knit", color: "#E2725B" },
  ...
  { id: "cb-055", name: "Oatmeal",        nameRu: "Овсянка",            shape: "buckyball", size: 0.24, material: "knit", color: "#D4C5A9" },
  { id: "cb-056", name: "Warm Gray",      nameRu: "Тёплый серый",        shape: "sphere",    size: 0.20, material: "knit", color: "#A9A9A9" },
  { id: "cb-057", name: "Moss",           nameRu: "Мох",                shape: "oblate",    size: 0.21, material: "knit", color: "#8A9A5B" },
  ...
  { id: "cb-060", name: "Dune",           nameRu: "Дюна",               shape: "buckyball", size: 0.22, material: "knit", color: "#D2B48C" },
  ...
  { id: "cb-063", name: "Milk",           nameRu: "Молоко",             shape: "oblate",    size: 0.18, material: "knit", color: "#FEFEFE" },
  ...
  { id: "cb-069", name: "Cinnamon",       nameRu: "Корица",             shape: "buckyball", size: 0.21, material: "knit", color: "#D2691E" },
  { id: "cb-070", name: "Flax",           nameRu: "Лён-мак",            shape: "cylinder",  size: 0.18, material: "knit", color: "#EEDC82" },
  { id: "cb-071", name: "Pewter",         nameRu: "Олово",              shape: "oblate",    size: 0.20, material: "knit", color: "#8E8E8E" },
  { id: "cb-072", name: "Buttercream",    nameRu: "Сливочный крем",     shape: "sphere",    size: 0.23, material: "knit", color: "#FFFDD0" },
  { id: "cb-073", name: "Plum Knit",      nameRu: "Сливовый трикотаж",  shape: "buckyball", size: 0.20, material: "knit", color: "#8E4585" },
  { id: "cb-074", name: "Fawn",           nameRu: "Оленёнок",            shape: "sphere",    size: 0.19, material: "knit", color: "#E5AA70" },
  { id: "cb-075", name: "Charcoal Knit",  nameRu: "Угольный трикотаж",  shape: "oblate",    size: 0.22, material: "knit", color: "#36454F" },

  // ── Plastic (cb-076 .. cb-100) ──────────────────────────────────────────
  { id: "cb-076", name: "Cherry Red",     nameRu: "Вишнёвый",           shape: "buckyball", size: 0.20, material: "plastic", color: "#DC143C" },
  { id: "cb-077", name: "Royal Blue",     nameRu: "Королевский синий",  shape: "sphere",    size: 0.22, material: "plastic", color: "#4169E1" },
  { id: "cb-078", name: "Sunflower",      nameRu: "Подсолнух",          shape: "oblate",    size: 0.18, material: "plastic", color: "#FFD700" },
  { id: "cb-079", name: "Emerald",        nameRu: "Изумруд",            shape: "sphere",    size: 0.20, material: "plastic", color: "#50C878" },
  { id: "cb-080", name: "Tangerine",      nameRu: "Мандарин",           shape: "buckyball", size: 0.19, material: "plastic", color: "#FF9966" },
  { id: "cb-081", name: "Amethyst",       nameRu: "Аметист",            shape: "oblate",    size: 0.21, material: "plastic", color: "#9966CC" },
  ...
  { id: "cb-084", name: "Lime",           nameRu: "Лайм",               shape: "buckyball", size: 0.18, material: "plastic", color: "#32CD32" },
  { id: "cb-085", name: "Coral Red",      nameRu: "Коралловый красный", shape: "disc",      size: 0.16, material: "plastic", color: "#FF4040" },
  { id: "cb-086", name: "Turquoise",      nameRu: "Бирюза",             shape: "oblate",    size: 0.20, material: "plastic", color: "#30D5C8" },
  ...
  { id: "cb-089", name: "Ocean Blue",     nameRu: "Океанский синий",    shape: "buckyball", size: 0.24, material: "plastic", color: "#006994" },
  ...
  { id: "cb-092", name: "Teal",           nameRu: "Бирюзовый",          shape: "oblate",    size: 0.18, material: "plastic", color: "#008080" },
  { id: "cb-093", name: "Grape",          nameRu: "Виноград",           shape: "sphere",    size: 0.20, material: "plastic", color: "#6F2DA8" },
  { id: "cb-094", name: "Fire Engine",    nameRu: "Пожарная машина",    shape: "buckyball", size: 0.22, material: "plastic", color: "#CE2029" },
  ...
  { id: "cb-097", name: "Fuchsia",        nameRu: "Фуксия",             shape: "oblate",    size: 0.21, material: "plastic", color: "#FF77FF" },
  { id: "cb-098", name: "Cobalt",         nameRu: "Кобальт",            shape: "cylinder",  size: 0.19, material: "plastic", color: "#0047AB" },
  { id: "cb-099", name: "Copper",         nameRu: "Медь",               shape: "buckyball", size: 0.20, material: "plastic", color: "#B87333" },
  { id: "cb-100", name: "Neon Green",     nameRu: "Неоновый зелёный",   shape: "oblate",    size: 0.18, material: "plastic", color: "#39FF14" },
];
