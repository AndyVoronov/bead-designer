...
- [x] **T02: Prisma + Template model + seed + API routes** `est:1.5h`
...
- [x] **T03: Share page + share button + /editor route** `est:45m`
...
- [x] **T04: Template browser + home page redesign** `est:1h`
